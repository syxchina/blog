...
<link rel="stylesheet" href="__PUBLIC__/Css/public.css" />
    ...
    <body>
    	<form action="<?php echo U(GROUP_NAME . '/System/updateWater');?>" method="post">
    		<table class="table">
    			<tr>
    				<th colspan="2">水印配置</th>
    			</tr>
    			<tr>
    				<td align="right">水印模式1(图片)0(文字)</td>
    				<td><input type="text" name="WATER_MODEL" value="<?php echo C('water_model');?>" /></td>
    			</tr>
    			<tr>
